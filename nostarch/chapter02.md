...
you can see everything in it in the standard library documentation at *../std/prelude/index.html*.
...
library. However, the Rust team does provide a `rand` crate at *https://crates.io/crates/rand* with
said functionality.
...
from Crates.io at *https://crates.io/*. Crates.io is where people in the Rust ecosystem
...
`Result`” at *#handling-potential-failure-with-result*<!-- ignore-->). We’ll treat
