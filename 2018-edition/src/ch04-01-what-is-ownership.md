...
![alt text](img/trpl04-01.png "String in memory")
...
![alt text](img/trpl04-02.png "s1 and s2 pointing to the same value")
...
![alt text](img/trpl04-03.png "s1 and s2 to two places")
...
![alt text](img/trpl04-04.png "s1 moved to s2")
