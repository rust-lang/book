...
![alt text](img/trpl14-01.png "Rendered HTML documentation for the `add_one` function of `my_crate`")
...
![alt text](img/trpl14-02.png "Rendered HTML documentation with a comment for the crate as a whole")
...
![alt text](img/trpl14-03.png "Rendered documentation for the `art` crate that lists the `kinds` and `utils` modules")
...
![alt text](img/trpl14-04.png "Rendered documentation for the `art` crate with the re-exports on the front page")
