...
تقسم Rust الأخطاء (errors) إلى فئتين رئيسيتين: الأخطاء القابلة للاسترداد (recoverable errors) والأخطاء غير
القابلة للاسترداد (unrecoverable errors). بالنسبة لـ _خطأ قابل للاسترداد_ (recoverable error)، مثل خطأ _عدم العثور على
ملف_، على الأرجح نريد فقط الإبلاغ عن المشكلة للمستخدم وإعادة محاولة العملية.
_الأخطاء غير القابلة للاسترداد_ (unrecoverable errors) هي دائمًا أعراض لوجود أخطاء برمجية (bugs)، مثل
