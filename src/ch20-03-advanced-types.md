...
قيد السِمَة على `?Sized` يعني "`T` قد يكون أو لا يكون `Sized`"، وهذا التدوين يتجاوز الافتراضي بأن الأنواع العامة يجب أن يكون لها حجم معروف في وقت الترجمة. بناء الجملة `?Trait` بهذا المعنى متاح فقط لـ `Sized`، وليس لأي سِمَات أخرى.
