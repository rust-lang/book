...
that calls `poll`. If you look back at [Listing 17-4](ch17-01-futures-and-syntax.md#listing-17-4), where we printed out the
...
When we introduced the idea of pinning in [Listing 17-16](ch17-03-more-futures.md#listing-17-16), we ran into a very
...
from back in [Listing 17-17](ch17-03-more-futures.md#listing-17-17). We originally tried to move the futures produced by
