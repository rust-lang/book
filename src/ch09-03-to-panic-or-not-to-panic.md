...
confidently use the values they receive. Listing 9-09 shows one way to define a
...
<span class="caption">Listing 9-09: A `Guess` type that will only continue with
