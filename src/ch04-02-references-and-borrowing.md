...
A *reference* is like a pointer, i.e it's an address that we can follow to access
the data stored at that address (data, which is owned by some other variable).
