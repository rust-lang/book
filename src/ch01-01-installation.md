...
تقوم الخطوات التالية بتثبيت أحدث إصدار مستقر من مصرِّف Rust. تضمن ضمانات الاستقرار في Rust أن جميع الأمثلة في الكتاب التي يتم ترجمتها ستستمر في الترجمة مع إصدارات Rust الأحدث. قد يختلف الناتج قليلاً بين الإصدارات لأن Rust غالباً ما يحسّن رسائل الأخطاء والتحذيرات. بعبارة أخرى، أي إصدار أحدث ومستقر من Rust تقوم بتثبيته باستخدام هذه الخطوات يجب أن يعمل كما هو متوقع مع محتوى هذا الكتاب.
...
ستحتاج أيضاً إلى _رابط (linker)_، وهو برنامج يستخدمه Rust لضم مخرجاته المُترجمة في ملف واحد. من المحتمل أن يكون لديك واحد بالفعل. إذا حصلت على أخطاء رابط، يجب عليك تثبيت مصرِّف C، والذي عادةً ما يتضمن رابطاً. مصرِّف C مفيد أيضاً لأن بعض حزم Rust الشائعة تعتمد على كود C وستحتاج إلى مصرِّف C.

على macOS، يمكنك الحصول على مصرِّف C عن طريق تشغيل:
...
على Windows، انتقل إلى [https://www.rust-lang.org/tools/install][install]<!-- ignore --> واتبع التعليمات لتثبيت Rust. في مرحلة ما من التثبيت، سيُطلب منك تثبيت Visual Studio. يوفر هذا رابطاً والمكتبات الأصلية اللازمة لترجمة البرامج. إذا كنت بحاجة إلى مزيد من المساعدة في هذه الخطوة، راجع [https://rust-lang.github.io/rustup/installation/windows-msvc.html][msvc]<!-- ignore -->.
