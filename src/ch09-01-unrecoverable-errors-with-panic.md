...
the macro directly. [Listing 9-1](#9-1) has some code that attempts to access an
...
<span class="caption" id="9-1">Listing 9-1: Attempting to access an element beyond the
...
except 0. [Listing 9-2](#9-2) shows output similar to what you’ll see.
...
<span class="caption" id="9-2">Listing 9-2: The backtrace generated by a call to
...
In the output in [Listing 9-2](#9-2), line 6 of the backtrace points to the line in our
...
to by the first line mentioning a file we wrote. In [Listing 9-1](#9-1), where we
