...
بعد ذلك، لاحظ أن دالة `unwrap_or_else` لديها معامل نوع عمومي إضافي `F`. نوع `F` هو نوع المعامل المسمى `f`, وهو الإغلاق الذي نقدمه عند استدعاء `unwrap_or_else`.
