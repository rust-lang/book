...
تم تضمين أداة `rustfix` مع تثبيتات Rust ويمكنها إصلاح تحذيرات المترجم تلقائياً
التي لديها طريقة واضحة لتصحيح المشكلة التي من المحتمل أن تكون ما تريده. ربما
رأيت تحذيرات المترجم من قبل. على سبيل المثال، ضع في اعتبارك هذا الكود:
...
المساعدة المرتكزة على المترجم التي تتحدث [بروتوكول خادم اللغة][lsp]<!--
