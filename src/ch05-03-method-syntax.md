...
لا يوجد سبب لفصل هذه الدوال إلى كتل `impl` متعددة هنا، لكن هذه صيغة صحيحة. سنرى حالة تكون فيها كتل `impl` المتعددة مفيدة في الفصل 10، حيث نناقش الأنواع العمومية والخصائص (traits).
