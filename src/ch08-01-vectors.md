...
من نفس النوع فقط. تكون مفيدة عندما يكون لديك قائمة من العناصر، مثل
...
لاحظ أننا أضفنا تعليقًا توضيحيًا للنوع هنا. لأننا لا نقوم بإدراج أي
قيم في هذا المتجه، لا يعرف Rust نوع العناصر التي ننوي
تخزينها. هذه نقطة مهمة. يتم تنفيذ المتجهات باستخدام الأنواع العامة (generics)؛
سنغطي كيفية استخدام الأنواع العامة مع أنواعك الخاصة في الفصل 10. في الوقت الحالي،
...
هناك طريقتان للإشارة إلى قيمة مخزنة في متجه: عبر الفهرسة أو عن طريق
...
<Listing number="8-4" caption="استخدام صيغة الفهرسة واستخدام طريقة `get` للوصول إلى عنصر في متجه">
...
لاحظ بعض التفاصيل هنا. نستخدم قيمة الفهرس `2` للحصول على العنصر الثالث
...
في القائمة 8-7 والقائمة 8-8، سنحصل على خطأ في المترجم
...
يحتاج Rust إلى معرفة أنواع ما سيكون في المتجه في وقت التجميع حتى
يعرف بالضبط مقدار الذاكرة على الكومة التي ستكون مطلوبة لتخزين كل عنصر.
...
في وقت التجميع أنه يتم التعامل مع كل حالة ممكنة، كما تمت مناقشته في الفصل 6.
