...
الاختبار مهارة معقدة: على الرغم من أننا لا نستطيع تغطية كل التفاصيل حول كيفية كتابة اختبارات جيدة في فصل واحد، سنناقش في هذا الفصل آليات تسهيلات الاختبار في Rust. سنتحدث عن التعليقات التوضيحية والماكرو المتاح لك عند كتابة اختباراتك، والسلوك الافتراضي والخيارات المقدمة لتشغيل اختباراتك، وكيفية تنظيم الاختبارات إلى اختبارات الوحدة واختبارات التكامل.
