...
Let’s return to our cons list example in [Listing 15-5](ch15-01-box.md#listing-15-5). Recall that we defined
...
in [Listing 15-17](#listing-15-17), but not in every scenario.
