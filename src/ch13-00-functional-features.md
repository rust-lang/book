...
استلهم تصميم Rust من العديد من اللغات والتقنيات الموجودة، وأحد التأثيرات المهمة هو _البرمجة الوظيفية_ (functional programming). غالبًا ما تتضمن البرمجة بأسلوب وظيفي استخدام الدوال كقيم من خلال تمريرها في الوسائط، وإرجاعها من دوال أخرى، وتعيينها إلى متغيرات للتنفيذ لاحقًا، وما إلى ذلك.
