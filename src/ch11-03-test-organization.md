...
build`. هذا يوفر وقت التجميع عندما تريد فقط بناء المكتبة ويوفر مساحة في
...
في دليل _tests_ للمساعدة في تنظيمها؛ على سبيل المثال، يمكنك تجميع دوال
الاختبار حسب الوظائف التي تختبرها. كما ذكرنا سابقًا، يتم تجميع كل ملف في
...
_tests_ لا يتم تجميعها كصناديق منفصلة أو لها أقسام في إخراج الاختبار.
