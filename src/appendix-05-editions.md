## الملحق (Appendix) هـ: الإصدارات (Editions)
...
تتبع لغة Rust والمصرِّف الخاص بها دورة إصدار مدتها ستة أسابيع، مما يعني أن
...
يشير مفتاح `edition` في _Cargo.toml_ إلى الإصدار الذي يجب على المصرِّف استخدامه
...
حتى عندما تقوم بترقية إصدار مصرِّف Rust الذي تستخدمه.

تدعم جميع إصدارات مصرِّف Rust أي إصدار كان موجوداً قبل إصدار ذلك المصرِّف، ويمكنها
ربط صناديق (crates) من أي إصدارات مدعومة معاً. تؤثر تغييرات الإصدار فقط على
الطريقة التي يحلل بها المصرِّف الكود في البداية. لذلك، إذا كنت تستخدم Rust 2015
