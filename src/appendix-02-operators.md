## الملحق (Appendix) ب: المعاملات (Operators) والرموز (Symbols)

يحتوي هذا الملحق على مسرد لصيغة Rust، بما في ذلك المعاملات والرموز الأخرى التي تظهر بمفردها أو في سياق المسارات، الأنواع العمومية، حدود الخصائص، الماكرو، السمات، التعليقات، المجموعات، والأقواس.

### المعاملات (Operators)

يحتوي الجدول ب-1 على المعاملات (Operators) في Rust، مثال على كيفية ظهور المعامل (Operator) في السياق، شرح موجز، وما إذا كان يمكن تحميل ذلك المعامل زائدًا. إذا كان المعامل قابلاً للتحميل الزائد، فسيتم إدراج الخاصية ذات الصلة لاستخدامها لتحميل ذلك المعامل زائدًا.

<span class="caption">الجدول ب-1: المعاملات (Operators)</span>
...
### الرموز (Symbols) غير المعاملات (Operators)

تحتوي الجداول التالية على جميع الرموز (Symbols) التي لا تعمل كمعاملات (Operators)؛ أي أنها لا تتصرف مثل استدعاء دالة أو طريقة.
...
يُظهر الجدول ب-4 الرموز التي تظهر في سياق استخدام معاملات الأنواع العمومية.

<span class="caption">الجدول ب-4: الأنواع العمومية</span>
...
| `type<ident=type>`             | نوع عمومي حيث واحد أو أكثر من الأنواع المرتبطة لها تعيينات محددة (على سبيل المثال، `Iterator<Item=T>`)                        |

يُظهر الجدول ب-5 الرموز التي تظهر في سياق تقييد معاملات الأنواع العمومية بحدود الخصائص.
...
يُظهر الجدول ب-6 الرموز التي تظهر في سياق استدعاء أو تعريف الماكرو وتحديد السمات على عنصر.

<span class="caption">الجدول ب-6: الماكرو والسمات</span>
