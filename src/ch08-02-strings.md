## تخزين نص مشفر بـ UTF-8 مع السلاسل النصية (Strings)
...
نناقش السلاسل النصية في سياق المجموعات (collections) لأن السلاسل النصية مطبقة كمجموعة من
...
مثل الإنشاء والتحديث (update) والقراءة. سنناقش أيضًا الطرق التي يختلف بها `String` عن
المجموعات الأخرى، أي كيف أن الفهرسة (indexing) في `String` معقدة بسبب الاختلافات بين كيفية
...
سنحدد أولاً ما نعنيه بمصطلح _سلسلة نصية_ (string). لدى Rust نوع سلسلة نصية واحد فقط في
...
### الفهرسة (Indexing) في السلاسل النصية

في العديد من لغات البرمجة الأخرى، يعد الوصول إلى الأحرف الفردية في سلسلة نصية
عن طريق الإشارة إليها بالفهرس (index) عملية صالحة وشائعة. ومع ذلك، إذا حاولت الوصول إلى
