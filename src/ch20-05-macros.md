...
[Listing 20-35](#listing-20-35) shows a slightly simplified definition of the `vec!` macro.
...
to eliminate in the future. In [Listing 20-36](#listing-20-36), we show how to define a
...
programmer to write code like [Listing 20-37](#listing-20-37) using our crate.
...
the trait to achieve the desired functionality, as in [Listing 20-39](#listing-20-39).
...
To start defining the procedural macro, place the code in [Listing 20-40](#listing-20-40) into
...
parsed Rust code. [Listing 20-40](#listing-20-40) shows the relevant parts of the `DeriveInput`
struct we get from parsing the `struct Pancakes;` string.

<Listing number="20-41" caption="The `DeriveInput` instance we get when parsing the code that has the macro’s attribute in [Listing 20-37](#listing-20-37)">
...
`HelloMacro` trait on the annotated type, as shown in [Listing 20-42](#listing-20-42).
...
Put the code in [Listing 20-37](#listing-20-37) into _src/main.rs_, and run `cargo run`: it
