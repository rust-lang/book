...
stands for _configuration_ and tells Rust that the following item should only
...
_tests/common.rs_, we’ll create _tests/common/mod.rs_. The project directory
now looks like this:
...
_src/main.rs_ file will work as well, and that small amount of code doesn’t
need to be tested.
