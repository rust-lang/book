...
_application binary interface (ABI)_ the external function uses: the ABI
...
> tell the Rust compiler not to mangle the name of this function. _Mangling_ is
...
In Rust, global variables are called _static_ variables. Listing 19-9 shows an
...
_unsafe_. Listing 19-10 shows how to declare, access, and modify a mutable
