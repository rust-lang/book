...
<span class="caption">Listing 5-2: 구조체 `User`로 인스턴스 생성하기</span>
...
유사 유닛 구조체는 특정한 타입의 특성(trait)을 구현해야하지만 타입 자체에 데이터를 저장하지 않는
경우에 유용합니다. 특성(trait)에 대해서는 10장에서 더 살펴보도록 하겠습니다.
