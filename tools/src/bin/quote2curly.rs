...
fn replace_straights_by_curlys(
    line : &str,
    modified_line : &mut std::string::String,
    mut is_in_inline_code : bool,
    mut is_in_html_tag: bool ){
...
fn main () {
    ...
    for line in lines {
        ...
        if !is_in_code_block {
            ...
            replace_straights_by_curlys(line, modified_line, is_in_inline_code, is_in_html_tag);
