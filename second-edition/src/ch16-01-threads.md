...
it needs. [Listing 16-3][Listing-16-3] shows an attempt to create a vector in the main thread
...
should borrow the values. The modification to [Listing 16-3][Listing-16-3] shown in Listing 16-5
