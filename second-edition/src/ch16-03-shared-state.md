...
did in [Listing 16-12][Listing-16-12]. Next, we’re creating 10 threads by mapping over a range
...
In the main thread, we collect all the join handles, as we did in [Listing 16-2][Listing-16-2],
...
[Listing 16-15][Listing-16-15] will finally compile and run:
